...
const sortedCards = computed(() => {
  if (props.sortRatingDirection === "none") return cards.value;

  const dir = props.sortRatingDirection === "asc" ? -1 : 1;

  return cards.value.toSorted((a, b) => dir * (b.rating.rate - a.rating.rate));
});
